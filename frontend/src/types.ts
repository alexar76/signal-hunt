...
export type Engagement = {
  ...
  // Only present once this session has committed a verdict.
  field?: {
    submissions: number;
    correct: number;
...
export type Round = {
  ...
  signal: {
    sealed: boolean;
    // 'sealed' until a verdict is submitted — severity is part of the answer.
    severity: 'sealed' | 'anomaly' | 'calm' | 'unsettled';
    tension?: { band: 'low' | 'elevated' | 'high'; measured_rules: number } | null;
